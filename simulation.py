...
# model simulation
# # ========== Dirichlet Model ==========
# dir_hv = model.simulate(reward_means, hv, model='Dir', AB_freq=100, CD_freq=50, num_iterations=5000)
# dir_mv = model.simulate(reward_means, mv, model='Dir', AB_freq=100, CD_freq=50, num_iterations=5000)
# dir_lv = model.simulate(reward_means, lv, model='Dir', AB_freq=100, CD_freq=50, num_iterations=5000)
#
...
# gau_hv = model.simulate(reward_means, hv, model='Gau', AB_freq=100, CD_freq=50, num_iterations=5000)
# gau_mv = model.simulate(reward_means, mv, model='Gau', AB_freq=100, CD_freq=50, num_iterations=5000)
# gau_lv = model.simulate(reward_means, lv, model='Gau', AB_freq=100, CD_freq=50, num_iterations=5000)
#
...
#
# # ========== Dual Process Model ==========
# dual_hv = model.simulate(reward_means, hv, model='Dual', AB_freq=100, CD_freq=50, num_iterations=5000)
# dual_mv = model.simulate(reward_means, mv, model='Dual', AB_freq=100, CD_freq=50, num_iterations=5000)
# dual_lv = model.simulate(reward_means, lv, model='Dual', AB_freq=100, CD_freq=50, num_iterations=5000)
#
...
#
# decay_hv = decay.simulate(reward_means, hv, AB_freq=100, CD_freq=50, num_iterations=5000)
# decay_mv = decay.simulate(reward_means, mv, AB_freq=100, CD_freq=50, num_iterations=5000)
# decay_lv = decay.simulate(reward_means, lv, AB_freq=100, CD_freq=50, num_iterations=5000)
#
# delta_hv = delta.simulate(reward_means, hv, AB_freq=100, CD_freq=50, num_iterations=5000)
# delta_mv = delta.simulate(reward_means, mv, AB_freq=100, CD_freq=50, num_iterations=5000)
# delta_lv = delta.simulate(reward_means, lv, AB_freq=100, CD_freq=50, num_iterations=5000)
...
actr_hv = actr.simulate(reward_means, hv, AB_freq=100, CD_freq=50, num_iterations=10)
